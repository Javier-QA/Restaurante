        ...
        <form action="{{ route('pos.checkout', $order->id) }}" method="POST" class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body p-4">
                ...
                <div class="row g-2 mb-3">
                    ...
                    <div class="col-4">
    <div class="position-relative pos-document-wrap">
        <select name="document_type" class="form-select fw-bold pos-document-select">
            <option value="Ticket">Ticket</option>
            <option value="Boleta">Boleta</option>
            <option value="Factura">Factura</option>
        </select>

        <i class="bi bi-chevron-down pos-document-arrow"></i>
    </div>
</div>
                </div>
