...
class SunatTestCommand extends Command
{
    ...
    protected $description = 'Emite un comprobante de prueba contra SUNAT BETA';
    ...
    public function handle(): int
    {
        ...
        // 1. Mostrar configuración SUNAT actual
        ...
        $this->table(
            ...
            [
                ...
                ['Usuario SOL',   $config->solUser()],
                ['Certificado',   $config->certPath() ?: '(usando demo de Greenter)'],
                ['IGV',           $config->igvRate() . '%'],
            ]
        );
        ...
        // 3. Enviar a SUNAT
        $this->info('→ Firmando XML y enviando a SUNAT...');
